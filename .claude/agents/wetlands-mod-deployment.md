...
- **VPS**: DigitalOcean con SSH access (gabriel@<VPS_IP>)
...
rsync -avz --progress server/mods/$MOD_NAME/ gabriel@<VPS_IP>:/home/gabriel/luanti-voxelibre-server/server/mods/$MOD_NAME/
