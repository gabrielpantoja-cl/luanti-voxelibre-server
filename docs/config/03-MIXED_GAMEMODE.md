...
```bash
ssh gabriel@<VPS_IP> "echo 'load_mod_creative_force = true' >> /home/gabriel/luanti-voxelibre-server/server/worlds/world/world.mt"
...
ssh gabriel@<VPS_IP> "grep -q 'load_mod_creative_force' /home/gabriel/luanti-voxelibre-server/server/worlds/world/world.mt || echo 'load_mod_creative_force = true' >> /home/gabriel/luanti-voxelibre-server/server/worlds/world/world.mt"
