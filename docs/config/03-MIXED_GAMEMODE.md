...
cat "$PROJECT_PATH/server/mods/creative_force/init.lua" | \
  ssh <VPS_USER>@<VPS_IP> "cat > $PROJECT_PATH/server/mods/creative_force/init.lua"

# 2. Copiar pvp_arena actualizado
cat "$PROJECT_PATH/server/mods/pvp_arena/init.lua" | \
  ssh <VPS_USER>@<VPS_IP> "cat > $PROJECT_PATH/server/mods/pvp_arena/init.lua"
...
cat "server/mods/pvp_arena/init.lua" | ssh <VPS_USER>@<VPS_IP> "cat > $PROJECT_PATH/server/mods/pvp_arena/init.lua"
