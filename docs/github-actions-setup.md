...
|--------|--------|-------------|
| `VPS_HOST` | `<VPS_IP>` | IP del servidor VPS |
...
ssh-copy-id -i ~/.ssh/vps_vegan_wetlands.pub gabriel@<VPS_IP>

# 3. Probar conexión
ssh -i ~/.ssh/vps_vegan_wetlands gabriel@<VPS_IP>
...
# luanti.gabrielpantoja.cl → <VPS_IP>
