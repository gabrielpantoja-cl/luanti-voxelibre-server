...
| `protector` | Protector Redo (TenPlus1, upstream 2026-07-19): place a block to protect a cube (radius 7), right-click shows the area and adds members; spawn protected within 20 nodes. Replaced the command-based `voxelibre_protection` (disabled) on 2026-09-16 |
