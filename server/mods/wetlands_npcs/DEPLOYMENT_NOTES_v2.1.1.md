...
ssh gabriel@<VPS_IP> "cd /home/gabriel/luanti-voxelibre-server && git pull && docker-compose restart luanti-server"

# 4. Verificar logs
ssh gabriel@<VPS_IP> "cd /home/gabriel/luanti-voxelibre-server && docker-compose logs --tail=50 luanti-server | grep custom_villagers"
```
