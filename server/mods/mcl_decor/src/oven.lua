...
local function active_formspec(fuel_percent, item_percent)
	return "size[9,8.75]"..
	"label[0,4;"..core.formspec_escape(core.colorize("#313131", S("Inventory"))).."]"..
	"list[current_player;main;0,4.5;9,3;9]"..
	mcl_formspec.get_itemslot_bg(0,4.5,9,3)..
	"list[current_player;main;0,7.74;9,1;]"..
	mcl_formspec.get_itemslot_bg(0,7.74,9,1)..
	"label[2.75,0;"..core.formspec_escape(core.colorize("#313131", S("Oven"))).."]"..
	"list[context;src;2.75,0.5;1,1;]"..
	mcl_formspec.get_itemslot_bg(2.75,0.5,1,1)..
	"list[context;fuel;2.75,2.5;1,1;]"..
	mcl_formspec.get_itemslot_bg(2.75,2.5,1,1)..
	--"list[context;dst;5.75,1.5;1,1;]"..
	"list[context;dst;5.75,0.96;2,2;]"..
	mcl_formspec.get_itemslot_bg(5.75,0.96,2,2)..
...
local function oven_node_timer(pos, elapsed)
	...
	while elapsed_game_time > 0.00001 and update do
		...
		cookable = core.get_item_group(inv:get_stack("src", 1):get_name(), "smoker_cookable") == 1
		if cookable then
...
core.register_node("mcl_decor:oven", {
	description = S("Oven"),
	...
	_doc_items_usagehelp =
			S("Use the oven to open the furnace menu.").."\n"..
			S("Place a furnace fuel in the lower slot and the source material in the upper slot.").."\n"..
			S("The oven will slowly use its fuel to smelt the item.").."\n"..
			S("The result will be placed into one of the output slots at the right side.").."\n\n"..
...
core.register_node("mcl_decor:oven_active", {
...
core.register_craft({
	...
	recipe = {
		...
		{ "mcl_nether:quartz", "mcl_furnaces:furnace", "mcl_nether:quartz" },
		{ "mcl_nether:quartz", "xpanes:pane_natural_flat", "mcl_nether:quartz" },
	}
})
