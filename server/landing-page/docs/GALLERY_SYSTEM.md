...
ssh gabriel@<VPS_IP> "cd /home/gabriel/luanti-voxelibre-server && git fetch origin main && git reset --hard origin/main"
```
...
2. Confirmar que el repo en VPS esta actualizado: `ssh gabriel@<VPS_IP> "cd /home/gabriel/luanti-voxelibre-server && git log -1 --oneline"`
