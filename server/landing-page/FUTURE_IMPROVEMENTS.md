...
**Problema Actual**: Las imágenes se almacenan en el VPS (167.172.251.27), consumiendo espacio de disco y ancho de banda del servidor de juegos.
...
**Problema Actual**: Todo el tráfico web pasa por un solo VPS en Nueva York (167.172.251.27).
